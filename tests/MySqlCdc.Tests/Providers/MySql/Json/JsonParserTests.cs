...
namespace MySqlCdc.Tests.Providers
{
    public class JsonParserTests
    {
        ...
        public void Test_OpaqueDecimal()
        {
            ...
            Assert.Equal("\"000000001234567890112233445566778899001112223334445556667778889.9900011112\"", JsonParser.Parse(payload));
        }
